...
/**
 * Cria um novo aluno no MIEIC  e inscreve o ï¿½s cadeiras desejadas
 */
int Mieic::inscreverNovoAluno(){
	...
	try{
		...
		cout<<"nï¿½ de aluno ja existe: "<<numero<<endl;
		return -1;
...
/**
 * devolve a data atual em string para inscriï¿½ao em uc
 */
